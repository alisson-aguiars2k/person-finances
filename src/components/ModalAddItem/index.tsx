          ...
          <C.Body>
            <C.TitleArea>
              ...
              <C.InputTitle
                ...
                value={title}
                placeholder="Digite Sua Receita/Despesa"
              />
            </C.TitleArea>
            <C.CategoryArea>
              ...
              >
                <C.CategoryOption value="">
                  Selecione Uma categoria
                </C.CategoryOption>
                {categoriesOption.map((item, key,) => (
                  <C.CategoryOption key={key} value={item.category}>
                    {item.title}
                  </C.CategoryOption>
                ))}
              </C.CategorySelect>
            ...
            <C.Footer>
              <C.BtnAdd onClick={handleAddItem}>Adicionar</C.BtnAdd>
            </C.Footer>
          </C.Body>
